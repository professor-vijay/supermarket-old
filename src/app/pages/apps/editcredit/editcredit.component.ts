...
export class EditcreditComponent implements OnInit {
  ...
  getTransList()
  {
    ...
    this.Auth.getTransdata(this.credData).subscribe(data => {
     ...
     this.contactId = this.EditCredit.trans.contactId
      // this.trans.paymentTypeId = this.EditCredit.trans.paymentType.description
      this.trans.contacttype = this.EditCredit.trans.contactTypeId
      this.SuppliedById = this.EditCredit.trans.storeId
      this.description = this.EditCredit.trans.description;
      this.creditTypeStatus = this.EditCredit.creditTypeStr;
      this.DispatchById =  this.EditCredit.responsibleById;
      this.trans.amount = this.EditCredit.trans.amount;
     this.trans.description = this.EditCredit.trans.description;
    //  this.trans.supplier = this.EditCredit.trans.store.name;
    //  this.trans.name = this.EditCredit.trans.name;
     this.TransactionId = this.EditCredit.trans.transactionId;
      console.log("EditCredit",this.EditCredit)
      })
  }
