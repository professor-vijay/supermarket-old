...
export class ProductOptionsComponent implements OnInit {
  ...
  show = true;
  CompanyId: number;
  variant: any = { id: 0, name: "", description: "", price: 0, sortOrder: -1, variantGroupId: 0, companyId: 0, count: "", variantGroup: null }
  variantgroup: any = { id: 0, name: "", description: "", sortOrder: -1, companyId: 0 }
  variants: any = [];
  variantgroups: any = [];
  ...
  ngOnInit(): void {
    this.Auth.getloginfo().subscribe(data => {
     ...
     this.variant = { id: 0, name: "", description: "", price: 0, sortOrder: -1, variantGroupId: 0, companyId: this.loginfo.companyId, count: "", variantGroup: null }
  this.variantgroup = { id: 0, name: "", description: "", sortOrder: -1, companyId: this.loginfo.companyId }
    })
  ...
  getvariants() {
    this.Auth.getvariant_l(this.loginfo.companyId).subscribe(data => {
      this.variants = data;
        ...
        //   console.log(data)
          // if (this.datasavetype == "1") {
            this.Auth.addVariants_l(this.variant).subscribe(data => {
              ...
              this.Auth.updateoptiondb(data["variant"]).subscribe(data1 => {
                this.variant = { id: 0, name: "", description: "", price: 0, sortOrder: -1, variantGroupId: 0, companyId: this.loginfo.companyId, count: "", variantGroup: null }
                this.variantgroup = { id: 0, name: "", description: "", sortOrder: -1, companyId: this.loginfo.companyId }  
        ...
        //   console.log(data)
          // if (this.datasavetype == "1") {
            this.Auth.addVariantGroups_l(this.variantgroup).subscribe(data2 => {
              console.log(data2);
              this.submitted = false;
              this.Auth.updateoptiongroupdb(data2["variantGroup"]).subscribe(data1 => {
                this.variant = { id: 0, name: "", description: "", price: 0, sortOrder: -1, variantGroupId: 0, companyId: this.loginfo.companyId, count: "", variantGroup: null }
                this.variantgroup = { id: 0, name: "", description: "", sortOrder: -1, companyId: this.loginfo.companyId }  
